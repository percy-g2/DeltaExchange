...
class OpenOrdersFragment : BaseFragment(), SwipeRefreshLayout.OnRefreshListener, OrdersInterface {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ordersInterface = this@OpenOrdersFragment
    ...
    private fun loadOrders() {
        ...
        if (KotlinUtils.apiDetailsPresent(requireContext())) {
            ...
            openOrdersViewModel.getOrders(
                ...
                if (it != null) {
                    openOrdersRecyclerView.adapter = OpenOrdersAdapter(it, ordersInterface!!)
                }
